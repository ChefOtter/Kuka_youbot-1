...
m2= 1.318;m3= 0.821;m4= 0.769
l2= 0.033;l3=0.155;l4=0.135;
r2 =l2/2;r3=l3/2;r4=l4/2;
%planar arm has simple dynamics, single inertia is sufficient else it complicates 
I2=0.0031631; I3=0.0018468;I4=0.0006610; % parameters in the paper.
...
%
% Recent update 4/12/17 to make backwards compatable with R2015a
uIdx = zeros(length(T),1);
for i = 1:length(T)
    
    foundIdx = find(T(i)==inputTime,1,'last');
